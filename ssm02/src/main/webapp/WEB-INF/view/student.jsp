...
<body class="gray-bg">
        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="text" name="tbStudentName" class="form-control" id="txt_search_tbStudentName" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">年龄 </span>
			      <input type="text" name="tbStudentAge" class="" id="txt_search_tbStudentAge1" >
			      <input type="text" name="tbStudentAge" class="" id="txt_search_tbStudentAge2" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">生日 </span>
			      <input type="date" name="tbStudentBirthday" class="" id="txt_search_tbStudentBirthday1" >-
			      <input type="date" name="tbStudentBirthday" class="" id="txt_search_tbStudentBirthday1" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="txt_search_tbStudentTid" id = "txt_search_tbStudentTid">
			...
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveUser.htm" enctype="multipart/form-data">
						<input type="hidden" name="tbStudentId" id="hidden_txt_tbStudentId" value=""/>
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>学生姓名：</td>
								<td><input type="text" id="tbStudentName" name="tbStudentName"
									class="" aria-required="true" required/></td>
								<td>&nbsp;&nbsp;</td>
								<td>性别：</td>
								<td><input type="radio" id="tbStudentSex1" name="tbStudentSex"
									value="1" class="" aria-required="true" required/>男<input type="radio" id="tbStudentSex2" name="tbStudentSex"
									value="2" class="" aria-required="true" required/>女</td>
							</tr>
							<tr>
							<tr>
								<td>学生年龄：</td>
								<td><input type="text" id="tbStudentAge" name="tbStudentAge"
									class="" aria-required="true" required/></td>
								<td>&nbsp;&nbsp;</td>
								<td>头像：</td>
							...
							<tr>
								<td>生日：</td>
								<td><input type="date" id="tbStudentBirthday" name="tbStudentBirthday"
									class="" aria-required="true" required/></td>
							</tr>
							<tr>
								<td>负责老师：</td>
								<td colspan="4">
									<select class="form-control" name="tbStudentTid" id = "tbStudentTid" aria-required="true" required>
	...
	var TableInit = function () {
	    ...
	    oTableInit.Init = function () {
	        $('#table_user').bootstrapTable({
	           ...
	           // height: 500,                        //行高，如果没有设置height属性，表格自动根据记录条数觉得表格高度
	            uniqueId: "tbStudentId",                     //每一行的唯一标识，一般为主键列
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            tbStudentName: $("#txt_search_tbStudentName").val(),
	            age1: $("#txt_search_tbStudentAge1").val(),
	            age2: $("#txt_search_tbStudentAge2").val(),
	            birthday1: $("#txt_search_tbStudentBirthday1").val(),
	            birthday2: $("#txt_search_tbStudentBirthday2").val(),
	            tbStudentTid: $("#txt_search_tbStudentTid").val(),
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_add").click(function(){
	    		...
	    		$("#form_user").resetForm();
	    		document.getElementById("hidden_txt_tbStudentId").value='';
	...
	function initEditUser(getSelection){
		$('#hidden_txt_tbStudentId').val(getSelection.tbStudentId);
		$('#tbStudentName').val(getSelection.tbStudentName);
		if(getSelection.tbStudentSex=="1"){
			$('#tbStudentSex1').prop("checked",true)
		}else{
			$('#tbStudentSex2').prop("checked",true)
			
		}
		$('#tbStudentAge').val(getSelection.tbStudentAge);
		$('#tbStudentBirthday').val(new Date(getSelection.tbStudentBirthday).Format('yyyy-MM-dd'));
		$('#tbStudentTid').val(getSelection.tbStudentTid);
	}
